...
<article style="width: 1200px; margin: 0 auto; text-align: center;">
	...
	<form name="contractFrm" method="post" id="join">
		...
		<textarea rows="15" cols="100" style="padding: 10px;">제 1 장 총 칙
         제 1 조 (목적)
		...
		<input type="button" value="Next" class="submit" style=" float: right; width: 80px; height: 40px; border-radius: 20px; background: #000; color: #fff; cursor: pointer;" onclick="go_next()">
	</form>
</article>
