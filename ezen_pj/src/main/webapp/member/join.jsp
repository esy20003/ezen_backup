		...
		<div id="join_box">
			...
			<div class="join_content">
				<ul>
					...
					<li><label>생년월일</label><span>* 필수입력</span> <input type="text" name="birth" placeholder="생년월일을 입력해주세요 (입력예 yyyy-mm-dd)">
			...
			<div id="buttons">
				<input type="button" value="회원가입" class="submit" onclick="join_insert()">
